...
export default function SettlementCard({ settlement, participants }: SettlementCardProps) {
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="font-medium truncate">{fromParticipant.name}</div>
        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          <div className="flex-1 min-w-0 text-right">
            <div className="font-medium truncate">{toParticipant.name}</div>
            <div className="text-xl font-bold tabular-nums text-primary" data-testid="text-amount">
