...
Calculate balance for each participant based on their claims
Subtract payer's total bill from their balance
Match debtors with creditors using greedy algorithm
Track mutable creditor balances to prevent double-counting
Generate minimal set of transfers
